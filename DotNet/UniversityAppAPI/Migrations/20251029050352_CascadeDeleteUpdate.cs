    ...
    public partial class CascadeDeleteUpdate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Course__C92D71A75D578F3B", x => x.CourseId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Student__32C52B99AC4B9B31", x => x.StudentId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Course__FC00E000F11F13ED",
                table: "Course",
                column: "CourseCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Student__E9F06F16A1A40A2A",
                table: "Student",
                column: "RollNumber",
                unique: true);
        }
