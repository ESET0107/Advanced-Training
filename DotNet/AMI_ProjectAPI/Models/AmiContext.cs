...
public partial class AmiContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-EBR5I1OJ;Initial Catalog=AMI;Integrated Security=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BillReading>(entity =>
        {
            entity.HasKey(e => e.BillId).HasName("PK__BillRead__11F2FC4A2C1C4059");
            ...
            entity.HasOne(d => d.Consumer).WithMany(p => p.BillReadings)
                ...
                .HasConstraintName("FK__BillReadi__Consu__5FB337D6");

            entity.HasOne(d => d.Meter).WithMany(p => p.BillReadings)
                .HasForeignKey(d => d.MeterId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__BillReadi__Meter__60A75C0F");

            entity.HasOne(d => d.Tariff).WithMany(p => p.BillReadings)
                .HasForeignKey(d => d.TariffId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__BillReadi__Tarif__619B8048");
        });

        modelBuilder.Entity<Consumer>(entity =>
        {
            entity.HasKey(e => e.ConsumerId).HasName("PK__Consumer__63BBE99AE4EBE979");
        ...
        {
            entity.HasKey(e => e.DtrId).HasName("PK__DTR__F865635FCD399DB3");
        ...
        {
            entity.HasKey(e => e.FeederId).HasName("PK__Feeder__9B20B0FC9F271BB2");
        ...
        {
            entity.HasKey(e => e.MeterId).HasName("PK__Meter__59223B8C21AA5527");
        ...
        {
            entity.HasKey(e => e.ReadingId).HasName("PK__MeterRea__C80F9C6E85173F03");
        ...
        {
            entity.HasKey(e => e.SubstationId).HasName("PK__Substati__BB479C6FC8872F54");
        ...
        {
            entity.HasKey(e => e.TariffId).HasName("PK__Tariff__EBAF9D9319EBC4AF");
        ...
        {
            entity.HasKey(e => e.SlabId).HasName("PK__TariffSl__D61699219CB19B9F");
        ...
        {
            entity.HasKey(e => e.ZoneId).HasName("PK__Zone__60166795CC29EE21");
